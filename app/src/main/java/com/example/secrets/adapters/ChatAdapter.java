package com.example.secrets.adapters;
...
import com.example.secrets.databinding.ItemContainerRecievedMessageBinding;
import com.example.secrets.databinding.ItemContainerSentMessageBinding;
import com.example.secrets.databinding.ItemContainerUserBinding;
import com.example.secrets.models.ChatMessage;
...
public class ChatAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        {
            return new RecievedMessageViewHolder(ItemContainerRecievedMessageBinding
                    .inflate(LayoutInflater.from(parent.getContext())
                            ,parent,false)
            );
        }
